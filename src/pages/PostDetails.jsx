        ...
        <div className="flex gap-8 p-6">
          ...
          <div className="flex-1">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Author Name • Date</p>
            </div>

            {/* Featured Image Placeholder */}
            <div className="w-full h-64 bg-gray-200 border border-gray-300 rounded-lg flex items-center justify-center mb-8">
          ...
          <div className="w-64 space-y-8">
            ...
            <div>
              ...
              <div className="space-y-3">
                <button className="w-full bg-gray-300 hover:bg-gray-400 text-gray-700 py-2 px-4 rounded text-left">
                  Category 1
                </button>
                <button className="w-full bg-gray-300 hover:bg-gray-400 text-gray-700 py-2 px-4 rounded text-left">
                  Category 2
            ...
            <div>
              ...
              <div className="h-16 bg-gray-200 border border-gray-300 rounded"></div>
            </div>
          </div>
        </div>
      </div>
